 ...
 *
 * Class meant to handle the submissions on answers to set pit questions,
 * also handles the data of all team's pitData for quick viewing, and avoid keeping
 * in memory answers when not pit scouting.
 */
public class PitScoutActivity extends Activity implements Spinner.OnItemSelectedListener{
    ...
    private ArrayList<TeamPitData> pitData;
