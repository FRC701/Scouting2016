...
class SearchController():
    ...
    entryItemGenAuto = [("avgOff","Offensive Score >= "),
                        ...
                        ("totalAutoPortcullis","# of Times Crossed Portcullis in Auto >= "),
                        ("totalAutoChevaldeFrise","# of Times Crossed Cheval de Frise in Auto >= "),
                        ("totalAutoMoat","# of Times Crossed Moat in Auto >= "),
                        ("totalAutoRamparts","# of Times Crossed Ramparts in Auto >= "),
                        ("totalAutoDrawbridge","# of Times Crossed Darwbridge in Auto >= "),
                        ("totalAutoSallyPort","# of Times Crossed Sally Port in Auto >= "),
                        ("totalAutoRockWall","# of Times Crossed Rock Wall in Auto >= "),
                        ("totalAutoRoughTerrain","# of Times Crossed Rough Terrain in Auto >= "),
                        ("totalAutoLowBar","# of Times Crossed Low Bar in Auto >= "),
    ...
    entryItemTelePost = [("avgTeleScore","Tele Score >= "),
                         ("pTelePortcullisM","Avg # of Times Crossed Portcullis per Match >= "),
                         ("pTeleChevaldeFriseM","Avg # of Times Crossed Cheval de Frise per Match >= "),
                         ("pTeleMoatM","Avg # of Times Crossed Moat per Match >= "),
                         ("pTeleRampartsM","Avg # of Times Crossed Ramparts per Match >= "),
                         ("pTeleDrawbridgeM","Avg # of Times Crossed Drawbridge per Match >= "),
                         ("pTeleSallyPortM","Avg # of Times Crossed Sally Port per Match >= "),
                         ("pTeleRoughTerrainM","Avg # of Times Crossed Rough Terrain per Match >= "),
                         ("pTeleRockWallM","Avg # of Times Crossed Rock Wall per Match >= "),
                         ...
                         ("pTeleShootingPercentageHG2","High Goal Shooting Percentage >= "),
    ...
    Searches = {"avgOff":searchGreater,
                ...
                "totalAutoPortcullis":searchGreater,
                "totalAutoChevaldeFrise":searchGreater,
                "totalAutoMoat":searchGreater,
                "totalAutoRamparts":searchGreater,
                "totalAutoDrawbridge":searchGreater,
                "totalAutoSallyPort":searchGreater,
                "totalAutoRockWall":searchGreater,
                "totalAutoRoughTerrain":searchGreater,
                "totalAutoLowBar":searchGreater,
                ...
                "pTeleShootingPercentageHG2":searchGreater,
                ...
                "postPlayedDefensively":searchHas,
                "postPlayedAssistively":searchHas,
