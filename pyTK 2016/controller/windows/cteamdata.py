...
class TeamDataController():
    ...
    dataLabelVals = [("numMatch","Number of Matches: "),
                     ...
                     ("avgReachesDefencesScore","Average Auto Reaches Defences Score: "),
                     ...
                     ("pTelePortcullis","Percent Team Crossed Portcullis: "),
                     ("pTelePortcullisM","Percent Team Crossed Portcullis per Match: "),
                     ("pTeleChevaldeFrise","Percent Team Crossed Cheval de Frise: "),
                     ("pTeleChevaldeFriseM","Percent Team Crossed Cheval de Frise per Match: "),
                     ("pTeleMoat","Percent Team Crossed Moat: "),
                     ("pTeleMoatM","Percent Team Crossed Moat per Match: "),
                     ("pTeleRamparts","Percent Team Crossed Ramparts: "),
                     ("pTeleRampartsM","Percent Team Crossed Ramparts per Match: "),
                     ("pTeleDrawbridge","Percent Team Crossed Drawbridge: "),
                     ("pTeleDrawbridgeM","Percent Team Crossed Drawbridge per Match: "),
                     ("pTeleSallyPort","Percent Team Crossed Sally Port: "),
                     ("pTeleSallyPortM","Percent Team Crossed Sally Port per Match: "),
                     ("pTeleRoughTerrain","Percent Team Crossed Rough Terrain: "),
                     ("pTeleRoughTerrainM","Percent Team Crossed Rough Terrain per Match: "),
                     ("pTeleRockWall","Percent Team Crossed Rock Wall: "),
                     ("pTeleRockWallM","Percent Team Crossed Rock Wall per Match: "),
    ...
    maxminLabelVals = [("maxOffScore","Maximum Offensive Score: "),("minOffScore","Minimum Offensive Score: "),
                       ...
                       ("maxAutoCrossesDefencesScore","Maximum Auto Crosses Defences Score: "),("minAutoStackScore","Minimum Auto Crosses Defences Score: "),
                       ...
                       ("maxTeleDefencesDamageScore","Maximum Tele Defences Damage Score"),("minDefencesDamageScore","Minimum Tele Defences Damage Score"),
    ...
    graphVals = [("avgOff","Scores","oScores"),
                 ...
                 ("avgAutoReachesDefencesScore","Scores","autoReachesDefencesScores"),
                 ("avgAutoCrossesDefencesScore","Scores","autoCrossesDefencesScores"),
