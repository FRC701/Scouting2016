...
def assign_basic_team_values(team, entry):
    ...
    team.Info.autoPortcullis.append(int(entry.autoPortcullis))
    team.Info.autoChevaldeFrise.append(int(entry.autoChevaldeFrise))
    team.Info.autoMoat.append(int(entry.autoMoat))
    team.Info.autoRamparts.append(int(entry.autoRamparts))
    team.Info.autoDrawbridge.append(int(entry.autoDrawbridge))
    team.Info.autoSallyPort.append(int(entry.autoSallyPort))
    team.Info.autoRockWall.append(int(entry.autoRockWall))
    team.Info.autoRoughTerrain.append(int(entry.autoRoughTerrain))
    team.Info.autoLowBar.append(int(entry.autoLowBar))
